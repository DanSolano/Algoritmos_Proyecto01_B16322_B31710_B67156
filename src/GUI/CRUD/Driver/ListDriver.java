...
public class ListDriver extends javax.swing.JFrame {
    ...
    Queue<Driver> clients;

    public ListDriver() {
        initComponents();
        this.clients = Algoritmos_Proyecto01_B16322_B31710_B67156.DRIVER_QUEUE;
 ...
 public void fillJtClient(Queue<Driver> clientList) {
        ...
        if (!clientList.isEmpty()) {
            ...
            for (Driver driver : clients) {
                model.addRow(new Object[]{driver.getId(), driver.getName(), driver.getLastNameA(), driver.getLastNameB(), driver.getAge(),
                    driver.getKindVehicle(), driver.getPhoneNumber(), driver.getVehiclePlate(), driver.getDni()});
            }
